// -------------------------------------------------------------------------------------->
//
// DEFAULT VISUALIZATION OPTIONS FOR DISTRICT MAPS
//
// Shared by every build_*.js entry script. Per-district overrides come from `viz_options`
// in data/<District>.js and are merged over these defaults by the entry scripts.
//
// -------------------------------------------------------------------------------------->
